...
let Melilla=1;
    ...
    for(i = 0; i < votos0.length; i++){
        votos[i] =votos0[i]+votos1[i]+votos2[i]+votos3[i]+votos4[i]+votos5[i]+votos6[i]+votos7[i]+votos8[i]+votos9[i]
            +votos10[i]+votos11[i]+votos12[i]+votos13[i]+votos14[i]+votos15[i]+votos16[i]+votos17[i]+votos18[i]+votos19[i]
            +votos20[i]+votos21[i]+votos22[i]+votos23[i]+votos24[i]+votos25[i]+votos26[i]+votos27[i]+votos28[i]+votos29[i]
            +votos30[i]+votos31[i]+votos32[i]+votos33[i]+votos34[i]+votos35[i]+votos36[i]+votos37[i]+votos38[i]+votos39[i]
            +votos40[i]+votos41[i]+votos42[i]+votos43[i]+votos44[i]+votos45[i]+votos46[i]+votos47[i]+votos48[i]+votos49[i]
            +votos50[i]+votos51[i];
    }
    ...
    for (ct = 0; ct < numpartidos; ct++)
        resultado = resultado + "El partido <b>" + nombres[ct] + "</b> obtiene " + def[ct] + " esca&ntilde;os al haber obtenido <b>" + votos[ct] + "</b> votos.<br />";
		...
		partido8= nombres[8];
		partido9= nombres[9];
		partido10= nombres[10];
		partido11= nombres[11];
		partido12= nombres[12];
		partido13= nombres[13];
		partido14= nombres[14];
		partido15= nombres[15];
		partido16= nombres[16];
		partido17= nombres[17];
		partido18= nombres[18];
		...
		sessionStorage.setItem('nombres9', JSON.stringify(partido9));
		sessionStorage.setItem('nombres10', JSON.stringify(partido10));
		sessionStorage.setItem('nombres11', JSON.stringify(partido11));
		sessionStorage.setItem('nombres12', JSON.stringify(partido12));
		sessionStorage.setItem('nombres13', JSON.stringify(partido13));
		sessionStorage.setItem('nombres14', JSON.stringify(partido14));
		sessionStorage.setItem('nombres15', JSON.stringify(partido15));
		sessionStorage.setItem('nombres16', JSON.stringify(partido16));
		sessionStorage.setItem('nombres17', JSON.stringify(partido17));
		sessionStorage.setItem('nombres18', JSON.stringify(partido18));
		...
		sessionStorage.setItem('escano6', JSON.stringify(escano6));
		sessionStorage.setItem('escano7', JSON.stringify(escano7));
		sessionStorage.setItem('escano8', JSON.stringify(escano8));
        sessionStorage.setItem('escano9', JSON.stringify(escano9));
		sessionStorage.setItem('escano10', JSON.stringify(escano10));
		sessionStorage.setItem('escano11', JSON.stringify(escano11));
		sessionStorage.setItem('escano12', JSON.stringify(escano12));
        sessionStorage.setItem('escano13', JSON.stringify(escano13));
		sessionStorage.setItem('escano14', JSON.stringify(escano14));
		sessionStorage.setItem('escano15', JSON.stringify(escano15));
		sessionStorage.setItem('escano16', JSON.stringify(escano16));
        sessionStorage.setItem('escano17', JSON.stringify(escano17));
		sessionStorage.setItem('escano18', JSON.stringify(escano18));
...
function drawChart() {
	...
	var partidos9 = sessionStorage.getItem('nombres9');
    partidos9 = JSON.parse(partidos9);
	
	var partidos10 = sessionStorage.getItem('nombres10');
    partidos10 = JSON.parse(partidos10);
	
	var partidos11 = sessionStorage.getItem('nombres11');
    partidos11 = JSON.parse(partidos11);
	
	var partidos12 = sessionStorage.getItem('nombres12');
    partidos12 = JSON.parse(partidos12);
	
	var partidos13 = sessionStorage.getItem('nombres13');
    partidos13 = JSON.parse(partidos13);
	
	var partidos14 = sessionStorage.getItem('nombres14');
    partidos14 = JSON.parse(partidos14);
	
	var partidos15 = sessionStorage.getItem('nombres15');
    partidos15 = JSON.parse(partidos15);
	
	var partidos16 = sessionStorage.getItem('nombres16');
    partidos16 = JSON.parse(partidos16);
	
	var partidos17 = sessionStorage.getItem('nombres17');
    partidos17 = JSON.parse(partidos17);
	
	var partidos18 = sessionStorage.getItem('nombres18');
    partidos18 = JSON.parse(partidos18);
	...
	var escano6 = sessionStorage.getItem('escano6');
    escano6 = parseInt(JSON.parse(escano6));
	
	var escano7 = sessionStorage.getItem('escano7');
    escano7 = parseInt(JSON.parse(escano7));
	
	var escano8 = sessionStorage.getItem('escano8');
    escano8 = parseInt(JSON.parse(escano8));
   
	var escano9 = sessionStorage.getItem('escano9');
    escano9 = parseInt(JSON.parse(escano9));
	
	var escano10 = sessionStorage.getItem('escano10');
    escano10 = parseInt(JSON.parse(escano10));
	
	var escano11 = sessionStorage.getItem('escano11');
    escano11 = parseInt(JSON.parse(escano11));
	
	var escano12 = sessionStorage.getItem('escano12');
    escano12 = parseInt(JSON.parse(escano12));
   
	var escano13 = sessionStorage.getItem('escano13');
    escano13 = parseInt(JSON.parse(escano13));
	
	var escano14 = sessionStorage.getItem('escano14');
    escano14 = parseInt(JSON.parse(escano14));
	
	var escano15 = sessionStorage.getItem('escano15');
    escano15 = parseInt(JSON.parse(escano15));
	
	var escano16 = sessionStorage.getItem('escano16');
    escano16 = parseInt(JSON.parse(escano16));
   
	var escano17 = sessionStorage.getItem('escano17');
    escano17 = parseInt(JSON.parse(escano17));
	
	var escano18 = sessionStorage.getItem('escano18');
    escano18 = parseInt(JSON.parse(escano18));
	...
	var MASPAIS = '#00FFCC';
	var CUP = 'yellow';
	var PODEMOSEU = '#9900FF';
	var PNC = '#FFFFCC';
	var NA = 'red';
	var COMPROMIS = '#FF9900';
	var BNG = '#33CCFF';
	var PRC = '#00CC66';
	var TE = '#009966';
