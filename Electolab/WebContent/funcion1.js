...
let Melilla=1;
    ...
    var prueba; //Cadena con el resultado


    prueba = "<b>Partidos:</b><br /><br />";
    for (ct = 0; ct < numpartidos; ct++) {prueba = prueba +nombres[ct] +";"};  

    document.getElementById("resultados").innerHTML = resultado;
    document.getElementById("pruebas").innerHTML = prueba;
