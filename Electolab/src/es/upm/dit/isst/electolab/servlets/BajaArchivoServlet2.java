...
@WebServlet("/BajaArchivoServlet2")
public class BajaArchivoServlet2 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        resp.setHeader("Content-Disposition", String.format("attachment; filename=\"%s\"", "Simulacion2.csv"));
        resp.setContentLength(usuario.getDocument2().length);
        resp.getOutputStream().write(usuario.getDocument2());
    }
}