...
@WebServlet("/BajaArchivoServlet5")
public class BajaArchivoServlet5 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        resp.setHeader("Content-Disposition", String.format("attachment; filename=\"%s\"", "Simulacion5.csv"));
        resp.setContentLength(usuario.getDocument5().length);
        resp.getOutputStream().write(usuario.getDocument5());
    }
}